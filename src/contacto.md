...
Para que podamos corregir el error más rápido, es útil que indiques:
- El nombre o número del cartel
- Qué dice actualmente el texto alternativo
- Qué debería decir, o qué te parece incorrecto
